...
function SetScaleModal() {
  ...
  const [metre, setMetre] = React.useState(1);
  ...
  const onSave = () => {
    const feet = parseInt(metre);
    const inches = parseInt(inchesInput);
    if (feet > 0 || inches > 0) {
      // Valid number entered
      dispatch(setScale({ ft: feet, in: inches, metre: feet }));
      setScaleModalOpen(false);
    } else {
      // Error
    }
              ...
              <Grid container>
                ...
                <Grid item>
                  <Grid container className={classes.inputContainer}>
                    ...
                    <Grid item xs>
                      <Typography style={{ paddingLeft: 4 }}>Meters</Typography>
                    </Grid>
                  </Grid>
                </Grid>
                ...
                {/* <Grid item>
                  <Grid container className={classes.inputContainer}>
                    ...
                    <Grid item xs>
                      <Typography style={{ paddingLeft: 4 }}>Cm</Typography>
                    </Grid>
                  </Grid>
                </Grid> */}
              </Grid>
